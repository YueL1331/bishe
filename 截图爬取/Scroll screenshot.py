...
# 创建保存截图的目录
output_dir = "D:/Git/bishe/截图爬取/pictures"
os.makedirs(output_dir, exist_ok=True)

# 指定 chromedriver 路径
chromedriver_path = "E:/网页图像爬取/chromedriver-win64/chromedriver.exe"  # 替换为实际的 chromedriver 路径
...
for cookie in cookies:
    cookie_dict = {
        'name': cookie.name,
        'value': cookie.value,
        'domain': cookie.domain,  # 强制设置为当前域名
        'path': cookie.path,
